/**
 * NYC zip code → neighborhood name mapping.
 * Covers all zip codes likely to appear in rent-stabilized building data.
 * Some zips span multiple neighborhoods — we pick the primary one.
 */
