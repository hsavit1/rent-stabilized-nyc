...
/** Fetch all lotteries for the map layer — they have lat/lng directly */
async function fetchAllLotteriesForMap(): Promise<HousingConnectLottery[]> {
  const all: HousingConnectLottery[] = []
  let offset = 0
  const pageSize = 2000
  while (true) {
